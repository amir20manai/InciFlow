...
// Composant : liste des notifications pour le technicien
@Component({
  selector: 'app-notification-technicien',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './notification.html',
  styleUrls: ['./notification.css']
})
export class NotificationTechnicien implements OnInit {
  ...
  determineType(message: string): 'critical' | 'assigned' | 'resolved' | 'info' {
    ...
    if (lower.includes('assigned') || lower.includes('affecté') || lower.includes('assigné')) return 'assigned';
